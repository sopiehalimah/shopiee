                    ...
                    <li >
                        ...
                        <ul class="ml-menu" >
                            ...
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{url('/blog/add')}}">Add</a>
                                    </li>
                                    <li>
                                        <a href="{{url('/blog/table')}}">Table</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="javascript:void(0);" class="menu-toggle">
                                    <span>Master Parent</span>
                                </a>
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{url('/master_parent/add')}}">Add</a>
                                    </li>
                                    <li>
                                        <a href="{{url('/master_parent/table')}}">Table</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="ml-menu">
                                    <li>
                                        <a href="{{url('/master_kind/add')}}">Add</a>
                                    </li>
                                    <li>
                                        <a href="{{url('/master_kind/table')}}">Table</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
