            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form method="post" action="{{url('/admin/profile/update')}}" enctype="multipart/form-data" style="padding-bottom: 30px;">
                        {!! csrf_field() !!}
                        ...
                        <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="image">
                                            <img src="{{ url('pict_user/'.Auth::User()->pict_user) }}" width="250" height="250" alt="User" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-line">
